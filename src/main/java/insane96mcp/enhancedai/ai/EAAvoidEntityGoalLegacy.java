...
public class EAAvoidEntityGoalLegacy<T extends LivingEntity> extends Goal {
	...
	public EAAvoidEntityGoalLegacy(PathfinderMob entityIn, Class<T> classToAvoidIn, float avoidDistance, float avoidDistanceNear, double nearSpeed, double farSpeed) {
	...
	public EAAvoidEntityGoalLegacy(PathfinderMob entityIn, Class<T> classToAvoidIn, IdTagMatcher idTagMatcher, float avoidDistance, float avoidDistanceNear, double nearSpeed, double farSpeed) {
	...
	public EAAvoidEntityGoalLegacy(PathfinderMob entityIn, Class<T> avoidClass, Predicate<LivingEntity> targetPredicate, float avoidDistance, float avoidDistanceNear, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> p_i48859_9_) {
	...
	public EAAvoidEntityGoalLegacy(PathfinderMob entityIn, Class<T> avoidClass, IdTagMatcher idTagMatcher, Predicate<LivingEntity> targetPredicate, float avoidDistance, float avoidDistanceNear, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> predicate) {
		this.goalOwner = entityIn;
		this.classToAvoid = avoidClass;
		this.avoidTargetSelector = targetPredicate;
		this.avoidDistance = avoidDistance * avoidDistance;
