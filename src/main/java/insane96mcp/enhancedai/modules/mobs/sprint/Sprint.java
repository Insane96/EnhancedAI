...
@LoadFeature(module = EAIModules.Ids.MOBS, description = "Makes mobs be able to move in more ways, like climbing or swim. Only entity types in `enhancedai:mobs/can_sprint` tag are affected by this feature.")
