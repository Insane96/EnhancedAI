...
@LoadFeature(module = EAIModules.Ids.MOBS, description = "Changes mobs attacks to use the attack speed attribute. Only entities in the `enhancedai:mobs/melee_attacking` entity type tag will be affected.")
