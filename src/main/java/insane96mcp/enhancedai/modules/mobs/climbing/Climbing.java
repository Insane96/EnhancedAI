...
@LoadFeature(module = EAIModules.Ids.MOBS, description = "Makes mobs be able to climb ladders and similar blocks. Only entity types in `enhancedai:mobs/can_climb` tag are affected by this feature.")
