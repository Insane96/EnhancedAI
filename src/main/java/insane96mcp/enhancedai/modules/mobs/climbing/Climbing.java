...
@LoadFeature(module = Modules.Ids.MOBS, description = "Makes mobs be able to move in more ways, like climbing or swim. Only entity types in `enhancedai:mobs/can_climb` tag are affected by this feature.")
public class Climbing extends Feature {
    ...
    public void onMobSpawn(EntityJoinLevelEvent event) {
		...
		if (mob.getType().is(AFFECTED_ENTITY_TYPES))
			CAN_CLIMB_DATA.applyIfAbsent(mob, mob.getRandom().nextDouble() < chance);
    }
}