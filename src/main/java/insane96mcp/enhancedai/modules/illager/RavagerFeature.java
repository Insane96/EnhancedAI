...
@LoadFeature(module = EAIModules.Ids.ILLAGER, canBeDisabled = false, description = "Adds a new block tag `enhancedai:breakable_by_ravager` for ravager to break (already includes leaves)")
