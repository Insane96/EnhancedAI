...
@LoadFeature(module = Modules.Ids.ILLAGER, canBeDisabled = false, description = "Adds a new block tag `enhancedai:ravager/breakable` for ravager to break (already includes leaves)")
