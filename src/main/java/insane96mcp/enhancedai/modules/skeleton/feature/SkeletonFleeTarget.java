...
public class SkeletonFleeTarget extends Feature {
    ...
    public void onReassessWeaponGoal(AbstractSkeleton skeleton) {
        ...
        boolean avoidTarget = NBTUtils.getBooleanOrPutDefault(persistentData, EAStrings.Tags.Flee.AVOID_TARGET, skeleton.level.random.nextDouble() < this.avoidPlayerChance);
        boolean attackWhenAvoiding = NBTUtils.getBooleanOrPutDefault(persistentData, EAStrings.Tags.Flee.ATTACK_WHEN_AVOIDING, skeleton.level.random.nextDouble() < this.attackWhenAvoidingChance);
