...
@LoadFeature(module = Modules.Ids.SNOW_GOLEM, description = "Snow golems snowballs freeze entities hit. Only entity types in enhancedai:snow_golem/freezing_snowballs tag are affected by this feature.")
