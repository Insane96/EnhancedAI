...
@LoadFeature(module = Modules.Ids.SNOW_GOLEM, description = "Snow golems are healed when hit by snowballs. Only entity types in enhancedai:snow_golem/healed_by_snowballs tag are affected by this feature.")
