...
@LoadFeature(module = EAIModules.Ids.DROWNED, description = "Makes drowned able to attack during daytime instead of standing still. Only entity types in the enhancedai:drowned/attack_during_day tag are affected by this feature.")
