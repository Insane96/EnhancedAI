...
@LoadFeature(module = Modules.Ids.DROWNED, description = "Makes drowned able to attack during daytime instead of standing still. Only entity types in the enhancedai:drowned/change_swimming tag are affected by this feature.")
