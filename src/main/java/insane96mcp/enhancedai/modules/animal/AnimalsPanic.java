...
@LoadFeature(module = EAIModules.Ids.ANIMAL, description = "Make animals panic when one is attacked. Only entity types in `enhancedai:animal/can_panic` tag will be affected by this feature.")
