...
@LoadFeature(module = Modules.Ids.ANIMAL, description = "Makes animals not tempted by food. Use the entity type tag enhancedai:can_ignore_food_temptation to change animals.")
