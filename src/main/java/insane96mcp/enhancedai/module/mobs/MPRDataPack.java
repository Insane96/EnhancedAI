...
@LoadFeature(module = EAIModules.MOBS, name = "MPR data pack", description = "Enables a Mobs Properties Randomness data pack that adds even more buffs to mobs. Only gets enabled if MPR is installed")
