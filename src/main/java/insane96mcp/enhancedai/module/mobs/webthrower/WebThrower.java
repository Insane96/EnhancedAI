...
public class WebThrower extends Feature {
	...
	public static MinMaxConfig cooldown = new MinMaxConfig(40, 60);
	...
	public static MinMaxConfig distance = new MinMaxConfig(2.5d, 32d);
