...
public class WebThrowGoal extends Goal {
	...
	public boolean canUse() {
		...
		double minDistance = WebThrower.DISTANCE_MIN.get(this.mob);
		minDistance *= minDistance;
		double maxDistance = WebThrower.DISTANCE_MAX.get(this.mob);
	...
	public void start() {
		...
		thrownWeb.setDamage(WebThrower.DAMAGE.get(this.mob).floatValue());
		...
		this.cooldown = adjustedTickDelay(WebThrower.COOLDOWN.get(this.mob));
	}
