...
public class EASounds {
	...
	public static final RegistryObject<SoundEvent> OLD_EXPLODE = SOUND_EVENTS.register("old_explode", () -> SoundEvent.createFixedRangeEvent(new ResourceLocation(EnhancedAI.MOD_ID, "old_explode"), 64f));
}
